    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden p-6 select-none">
      ...
      <div className="flex-1 overflow-y-auto pr-1">
        {playlistTracks.length === 0 ? (
          ...
          <div>
            <div className="grid grid-cols-[36px_1fr_1fr_1fr_60px_90px_64px] items-center px-3 py-2 text-[11px] font-bold uppercase tracking-wider text-foreground-subtle border-b border-border-subtle sticky top-0 bg-app/95 backdrop-blur z-10">
              <span>#</span>
              <span>Title</span>
              <span>Artist</span>
              <span>Album</span>
              ...
              {playlistTracks.map((track, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`group grid grid-cols-[36px_1fr_1fr_1fr_60px_90px_64px] items-center px-3 py-2 rounded-xl text-xs transition cursor-pointer ${
                      isCurrent
